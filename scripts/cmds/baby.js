    ...
    if (event.type !== "message_reply" && mahmud.some(word => message.startsWith(word))) {
      ...
      const res = await axios.post(`${await baseApiUrl()}/api/hinata`, { text, style: 3, attachments });  return res.data.message; } catch {  return "error janu🥹";
       ...
       const randomMessage = [
          ...
          "❥⃝🙈দি্ঁলে্ঁ লা্ঁগে্ঁ টা্ঁন্ঁ ❥⃝ 🫵   🪶কেউ হ্ঁবে্ঁ নাকি আ্ঁমা্ঁর্ঁ  জা্ঁন্ঁ😍❥❥⃝ʚ🫶☺️🙈",
          "༒ গাইষ!!”ছেঁকা খাইছি🙆🔨༒____===[[",
          "naw amr boss Onik k sms daw",
          "Amr Page Ta Follow Kore Daw bby 😜🤓",
          "~২ ঘঁন্টাঁ কাঁ’দাঁ’রঁ পঁরঁ,,,!!😰😭~ হঁটাঁৎ  মঁনে হলো 🤔~𝐈 𝐚𝐦 𝐭𝐨 সিঙ্গেল,,,😁",
          "গোলাপ ফুল এর জায়গায় আমি দিলাম তোমায় মেসেজ",
          "বলো কি বলবা, সবার সামনে বলবা নাকি?🤭🤏",  
          "https://www.facebook.com/profile.php?id=61586081537110",
          "𝗜 𝗵𝗮𝘁𝗲 𝘆𝗼𝘂__😏😏",
          "গোসল করে আসো যাও😑😩",
          "অ্যাসলামওয়ালিকুম",
          "কেমন আসো",
          "Facebook এ থুথু মারার Emoji নাই কেন🙄-তাহলে Block মারার আগে থুথু মারতাম য়ামিহ্😹🔨",
          "~২ ঘঁন্টাঁ কাঁ’দাঁ’রঁ পঁরঁ,,,!!😰😭~ হঁটাঁৎ  মঁনে হলো 🤔~𝐈 𝐚𝐦 𝐭𝐨 সিঙ্গেল,,,😁",
